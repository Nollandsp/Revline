...
const product = {
  ...
  images: [
    { src: "/Jesko/JeskoSide.webp", alt: "Koenigsegg Jesko Attack vue de côté" },
    { src: "/Jesko/JeskoFront.jpg", alt: "Koenigsegg Jesko Attack vue de face" },
    { src: "/Jesko/JeskoSide2.webp", alt: "Koenigsegg Jesko Attack vue de côté 2" },
    { src: "/Jesko/JeskoRide.jpg", alt: "Koenigsegg Jesko Attack en action" },
    { src: "/Jesko/JeskoInterior.jpg", alt: "Koenigsegg Jesko Attack intérieur" },
    { src: "/Jesko/JeskoInterior2.jpg", alt: "Koenigsegg Jesko Attack intérieur 2" },
  ],
  description:
    "La Koenigsegg Jesko Attack est une hypercar radicale orientée piste, conçue pour générer une charge aérodynamique extrême sans sacrifier les performances pures. Dotée d'un V8 biturbo 5,0 L développant 1 600 ch en mode E85 et d'une transmission révolutionnaire, elle représente le summum de la performance automobile.",
  highlights: [
  ...
  details:
    "La Jesko Attack est l'expression ultime de la technologie Koenigsegg. Son moteur V8 biturbo 5,0 litres est couplé à une boîte de vitesses révolutionnaire à neuf rapports sans synchros, permettant des changements instantanés. Grâce à son aérodynamique poussée et son châssis en carbone, elle redéfinit les limites de l'adhérence et de la maniabilité.",
};
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="flex items-center gap-4 mb-5">
              ...
              <span className="text-red-500 text-[10px] font-semibold tracking-[0.4em] uppercase font-body">Thermique — Piste</span>
            </motion.div>
            ...
            <motion.p initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="text-white/50 text-sm sm:text-base max-w-sm font-body leading-relaxed">
              La fusion parfaite entre innovation et puissance brute — 1 600 ch, 1 400 kg d&apos;appui aérodynamique, transmission révolutionnaire à 9 rapports.
            </motion.p>
          </div>
          <div className="hidden lg:flex justify-center items-center">
            <Image src="/Jesko/JeskoLogo.svg" alt="Koenigsegg" width={200} height={80} priority className="object-contain w-[55%] h-auto opacity-70" />
          </div>
        </div>
      </section>
        ...
        <div className="lg:flex lg:gap-12 lg:items-stretch">
          <div className="lg:w-1/2 space-y-0 mb-10 lg:mb-0">
            {[
              ...
              { value: 1600, suffix: " ch", label: "Puissance (E85)" },
              { value: 400, suffix: " km/h", label: "Vitesse maximale" },
            ].map((stat) => (
          ...
          <div className="relative lg:w-1/2 overflow-hidden h-[260px] sm:h-[320px] md:h-[380px]">
            <Image src="/Jesko/JeskoFront.jpg" alt="Koenigsegg Jesko Attack" fill className="object-cover" />
            ...
            <>
              ...
              <motion.div className="fixed top-0 right-0 h-full w-full sm:w-[480px] bg-neutral-950 border-l border-white/10 z-50 flex flex-col" initial={{ x: "100%" }} animate={{ x: 0 }} exit={{ x: "100%" }} transition={{ type: "tween", duration: 0.35 }}>
                <div className="flex items-start justify-between p-6 border-b border-red-600/25">
                  <div>
                    <p className="text-white/35 text-[10px] tracking-[0.35em] uppercase font-body mb-1">Koenigsegg Jesko Attack</p>
                ...
                <div className="p-6 overflow-y-auto flex-1">
                  <div className="w-full flex justify-center mb-8">
                    <Image src="/Jesko/JeskoCarac.webp" alt="Koenigsegg Jesko Attack" width={400} height={250} className="object-contain w-full max-w-xs" />
                  </div>
                  <div className="grid grid-cols-2 gap-px bg-white/5">
                    {[
                      { label: "Hauteur", value: "1 210 mm" },
                      { label: "Longueur", value: "4 626 mm" },
                      { label: "Empattement", value: "2 700 mm" },
                      { label: "Largeur", value: "2 030 mm" },
                    ].map((item) => (
      ...
      <section className="w-full relative">
        <Image src="/Jesko/JeskoDesign.webp" alt="Koenigsegg Jesko Attack design" width={1920} height={600} className="w-full h-[480px] sm:h-[580px] md:h-[680px] object-cover" priority />
        ...
        <div className="absolute bottom-8 sm:bottom-14 md:bottom-20 left-0 w-full px-6">
          <div className="max-w-7xl mx-auto">
            <span className="text-red-500 text-[10px] font-semibold tracking-[0.4em] uppercase font-body block mb-3">Ingénierie</span>
            <h2 className="font-display text-[clamp(1.8rem,4vw,4rem)] leading-none text-white uppercase mb-4">L&apos;ingénierie devenue art</h2>
            <p className="text-white/50 text-sm sm:text-base max-w-lg font-body leading-relaxed">Chaque courbe, chaque arête, chaque aileron traduit la recherche obsessionnelle de performance pure — la Jesko ne cherche pas la beauté, elle la crée à travers la vitesse.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 sm:py-20">
        <div className="flex items-center gap-4 mb-10">
          <span className="w-8 h-[1px] bg-red-600" />
          <span className="text-red-500 text-[10px] font-semibold tracking-[0.4em] uppercase font-body">Transmission vitesse lumière</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="relative cursor-pointer overflow-hidden group" onClick={() => setOpenPack1(true)}>
            <Image src="/Jesko/JeskoTransmi.png" alt="Koenigsegg Jesko Attack Transmission" width={1920} height={1080} className="w-full h-[200px] sm:h-[260px] md:h-[320px] object-cover transition-transform duration-700 group-hover:scale-[1.04]" priority />
            ...
            <div className="absolute bottom-5 sm:bottom-6 left-5 sm:left-6">
              <h3 className="font-display text-[clamp(1.2rem,2.5vw,1.8rem)] text-white uppercase leading-none mb-3">Transmission révolutionnaire</h3>
        ...
        {openPack1 && (
          <motion.div className="fixed inset-0 bg-black/95 flex flex-col justify-center items-center z-50 px-4 py-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <motion.div key="pack1" initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.97 }} transition={{ duration: 0.3 }} className="w-full max-w-[90vw] sm:max-w-[80vw] overflow-hidden h-[30vh] sm:h-[40vh] md:h-[55vh]">
              <Image src="/Jesko/JeskoTransmi2.png" alt="Koenigsegg Jesko Transmission" width={1200} height={600} className="w-full h-full object-cover" />
            </motion.div>
            <div className="w-full max-w-[90vw] sm:max-w-[80vw] bg-neutral-900 border-t border-red-600/25 p-5 sm:p-8">
              ...
              <p className="text-white/55 text-sm sm:text-base font-body leading-relaxed">
                La transmission Light Speed (LST) : neuf vitesses avant et sept embrayages multidisques dans un ensemble compact et ultra-léger. Elle permet des changements pratiquement instantanés entre n&apos;importe quelle vitesse — une évolution inédite depuis les doubles embrayages modernes.
              </p>
            </div>
          </motion.div>
        )}
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 sm:py-20">
        ...
        <h2 className="font-display text-[clamp(1.8rem,4vw,3.5rem)] text-white uppercase leading-none mb-10">Koenigsegg Jesko Attack</h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/5">
          {[
            { label: "Consommation combinée", value: "18,1 L/100km" },
            { label: "Consommation en ville", value: "34,3 L/100km" },
            { label: "Émissions CO₂", value: "410 g/km" },
      ...
      <section className="relative w-full h-[400px] sm:h-[500px] md:h-[580px]">
        <Image src="/Jesko/JeskoExhaust.webp" alt="Koenigsegg Jesko Attack" fill className="object-cover" priority />
        ...
        <div className="absolute top-8 sm:top-12 left-0 w-full px-6">
          <div className="max-w-7xl mx-auto text-center">
            <h2 className="font-display text-[clamp(1.8rem,4vw,4rem)] text-white uppercase leading-none mb-3">La symphonie du V8 biturbo</h2>
            <p className="text-white/55 text-sm sm:text-base max-w-lg mx-auto font-body">Le rugissement de la Jesko Attack ne se contente pas d&apos;être entendu — il se ressent. Chaque accélération libère une onde de puissance pure.</p>
          </div>
        </div>
