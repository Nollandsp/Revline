...
const product = {
  ...
  images: [
    { src: "/SF90XX/SF90XXroad.webp", alt: "Ferrari SF90 XX Stradale vue de face" },
    { src: "/SF90XX/SF90XXfront.jpg", alt: "Ferrari SF90 XX Stradale vue avant" },
    { src: "/SF90XX/SF90XXtop.jpg", alt: "Ferrari SF90 XX Stradale vue du dessus" },
    { src: "/SF90XX/SF90XXBack.jpg", alt: "Ferrari SF90 XX Stradale vue arrière" },
    { src: "/SF90XX/SF90XXinterior.jpg", alt: "Ferrari SF90 XX Stradale intérieur" },
    { src: "/SF90XX/SF90XXInterior.avif", alt: "Ferrari SF90 XX Stradale intérieur 2" },
  ],
  description:
  ...
  details:
    "La Ferrari SF90 XX Stradale repousse les limites du design et de la performance. Son moteur V8 biturbo, associé à un système hybride sophistiqué, délivre une puissance combinée de 1 030 ch. Ses innovations aérodynamiques augmentent l'appui et la stabilité à haute vitesse. Cette voiture incarne l'équilibre entre performance de piste et homologation route, pour une expérience de conduite plus intense et raffinée que jamais.",
};
...
export default function SF90XX() {
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="flex items-center gap-4 mb-5">
              ...
              <span className="text-red-500 text-[10px] font-semibold tracking-[0.4em] uppercase font-body">Hybride</span>
            </motion.div>
            ...
            <motion.p initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="text-white/50 text-sm sm:text-base max-w-sm font-body leading-relaxed">
              Chef-d&apos;œuvre d&apos;ingénierie — V8 biturbo et trois moteurs électriques pour 1 030 ch de puissance combinée.
            </motion.p>
          </div>
          <div className="hidden lg:flex justify-center items-center">
            <Image src="/SF90XX/FerrariLogo.png" alt="Ferrari" width={200} height={80} priority className="object-contain w-[55%] h-auto opacity-70" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16">
        <div className="lg:flex lg:gap-12 lg:items-stretch">
          <div className="lg:w-1/2 space-y-0 mb-10 lg:mb-0">
            {[
              { value: 2.3, suffix: " s", label: "0 → 100 km/h" },
              { value: 1030, suffix: " ch", label: "Puissance combinée" },
              { value: 320, suffix: " km/h", label: "Vitesse maximale" },
            ].map((stat) => (
          ...
          <div className="relative lg:w-1/2 overflow-hidden h-[260px] sm:h-[320px] md:h-[380px]">
            <Image src="/SF90XX/SF90XXstat.jpg" alt="Ferrari SF90 XX Stradale" fill className="object-cover" />
            ...
            <>
              ...
              <motion.div className="fixed top-0 right-0 h-full w-full sm:w-[480px] bg-neutral-950 border-l border-white/10 z-50 flex flex-col" initial={{ x: "100%" }} animate={{ x: 0 }} exit={{ x: "100%" }} transition={{ type: "tween", duration: 0.35 }}>
                <div className="flex items-start justify-between p-6 border-b border-red-600/25">
                  <div>
                    <p className="text-white/35 text-[10px] tracking-[0.35em] uppercase font-body mb-1">Ferrari SF90XX Stradale</p>
                ...
                <div className="p-6 overflow-y-auto flex-1">
                  <div className="w-full flex justify-center mb-8">
                    <Image src="/SF90XX/SF90XXcarac.jpg" alt="SF90XX châssis" width={400} height={250} className="object-contain w-full max-w-xs" />
                  </div>
                  <div className="grid grid-cols-2 gap-px bg-white/5">
                    {[
                      { label: "Hauteur", value: "1 225 mm" },
                      { label: "Longueur", value: "4 850 mm" },
                      { label: "Empattement", value: "2 650 mm" },
                      { label: "Largeur", value: "2 000 mm" },
                    ].map((item) => (
      ...
      <section className="w-full relative">
        <Image src="/SF90XX/SF90XXdesign.jpg" alt="Ferrari SF90 XX Stradale design" width={1920} height={600} className="w-full h-[480px] sm:h-[580px] md:h-[680px] object-cover" priority />
        ...
        <div className="absolute bottom-8 sm:bottom-14 md:bottom-20 left-0 w-full px-6">
          <div className="max-w-7xl mx-auto">
            <span className="text-red-500 text-[10px] font-semibold tracking-[0.4em] uppercase font-body block mb-3">Design</span>
            <h2 className="font-display text-[clamp(1.8rem,4vw,4rem)] leading-none text-white uppercase mb-4">Une sculpture en mouvement</h2>
            <p className="text-white/50 text-sm sm:text-base max-w-lg font-body leading-relaxed">Chaque ligne façonnée pour exprimer une agression élégante — aérodynamisme radical au service de la beauté pure.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 sm:py-20">
        <div className="flex items-center gap-4 mb-10">
          <span className="w-8 h-[1px] bg-red-600" />
          <span className="text-red-500 text-[10px] font-semibold tracking-[0.4em] uppercase font-body">Puissance & Aérodynamisme</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            { title: "Groupe propulseur", img: "/SF90XX/SF90XXengine.webp", alt: "SF90XX Engine", onClick: () => setOpenPack1(true) },
            { title: "Aérodynamisme extrême", img: "/SF90XX/SF90XXaero.webp", alt: "SF90XX aéro", onClick: () => setOpenPack2(true) },
          ].map((pack) => (
            <div key={pack.title} className="relative cursor-pointer overflow-hidden group" onClick={pack.onClick}>
              <Image src={pack.img} alt={pack.alt} width={1920} height={1080} className="w-full h-[200px] sm:h-[260px] md:h-[320px] object-cover transition-transform duration-700 group-hover:scale-[1.04]" priority />
              ...
              <div className="absolute bottom-5 sm:bottom-6 left-5 sm:left-6">
                <h3 className="font-display text-[clamp(1.2rem,2.5vw,1.8rem)] text-white uppercase leading-none mb-3">{pack.title}</h3>
        ...
        {openPack1 && (
          <motion.div className="fixed inset-0 bg-black/95 flex flex-col justify-center items-center z-50 px-4 py-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <motion.div key="pack1" initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.97 }} transition={{ duration: 0.3 }} className="w-full max-w-[90vw] sm:max-w-[80vw] overflow-hidden h-[30vh] sm:h-[40vh] md:h-[55vh]">
              <Image src="/SF90XX/SF90XXspeed.avif" alt="SF90XX groupe propulseur" width={1200} height={600} className="w-full h-full object-cover" />
            </motion.div>
            <div className="w-full max-w-[90vw] sm:max-w-[80vw] bg-neutral-900 border-t border-red-600/25 p-5 sm:p-8">
              <h3 className="font-display text-xl sm:text-2xl text-white uppercase mb-3">La perfection réside dans les détails</h3>
              <p className="text-white/55 text-sm sm:text-base font-body leading-relaxed">
                La SF90XX Stradale a hérité de la configuration PHEV de la SF90 Stradale — moteur V8 et trois moteurs électriques pour 1 030 CH, une nouvelle référence de performance Ferrari.
              </p>
            </div>
          </motion.div>
        )}
        ...
        {openPack2 && (
          <motion.div className="fixed inset-0 bg-black/95 flex flex-col justify-center items-center z-50 px-4 py-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <motion.div key="pack2" initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.97 }} transition={{ duration: 0.3 }} className="w-full max-w-[90vw] sm:max-w-[80vw] overflow-hidden h-[30vh] sm:h-[40vh] md:h-[55vh]">
              <video src="/SF90XX/SF90XXAero.mp4" autoPlay loop playsInline className="w-full h-full object-cover" />
            </motion.div>
            <div className="w-full max-w-[90vw] sm:max-w-[80vw] bg-neutral-900 border-t border-red-600/25 p-5 sm:p-8">
              <h3 className="font-display text-xl sm:text-2xl text-white uppercase mb-3">Une aile « XX » authentique</h3>
              <p className="text-white/55 text-sm sm:text-base font-body leading-relaxed">
                L&apos;aile fixe arrière optimise l&apos;interaction du champ de pression avec le shut-off Gurney — deux configurations : LD (Low Drag) et HD (High Downforce), générant jusqu&apos;à 530 kg d&apos;appui à 250 km/h.
              </p>
            </div>
          </motion.div>
        )}
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 sm:py-20">
        ...
        <h2 className="font-display text-[clamp(1.8rem,4vw,3.5rem)] text-white uppercase leading-none mb-10">Ferrari SF90 XX Stradale</h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/5">
          {[
            { label: "Consommation électrique", value: "132 WH/KM" },
            { label: "Consommation carburant", value: "10,0 L/100km" },
            { label: "Émissions CO₂", value: "228 g/km" },
      ...
      <section className="relative w-full h-[400px] sm:h-[500px] md:h-[580px]">
        <Image src="/SF90XX/SF90XXexhaust.jpeg" alt="Ferrari SF90XX Stradale" fill className="object-cover" priority />
        ...
        <div className="absolute top-8 sm:top-12 left-0 w-full px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-white/55 text-sm sm:text-base max-w-lg mx-auto font-body">Le V8 hybride — un rugissement unique entre performance extrême et sophistication mécanique.</p>
          </div>
        </div>
