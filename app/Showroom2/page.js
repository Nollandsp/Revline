    ...
    <>
      ...
      <section className="relative pt-28 sm:pt-36 lg:pt-44 pb-10 sm:pb-16 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            Showroom <span className="text-red-500">II</span>
          </motion.h1>
          ...
          >
            Éditions ultra-rares et hypercars d&apos;exception — au-delà des limites.
          </motion.p>
        </div>
      </section>
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-center justify-between">
                        <p className="text-white/45 text-xs font-body">
                          À partir de{" "}
                          <span className="text-white/75 font-semibold">{car.price}</span>
                        </p>
